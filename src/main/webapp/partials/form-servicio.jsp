<form class="form form-servicio p-5">

    <h2>COMPLETE LOS CAMPOS DEL SERVICIO</h2>
    ...
    <div class="row mb-4">
      ...
      <div class="col">
        ...
        <div class="input-group">
          ...
          <input type="text" class="form-control" id="input-tiempo" aria-label="Text input with checkbox" placeholder="¿Cuántos meses?" onkeypress="return valideKeyNumber(event);"/>
